...
const MainStack = () => {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Screen name="SalesBottomTabs" component={SalesBottomTab} />
      <Stack.Screen name="AddClient" component={AddClientScreen} />
      <Stack.Screen name="GetClientDetails" component={GetClientDetails} />
      <Stack.Screen name="DemoDetailScreen" component={DemoDetailScreen} />
      <Stack.Screen name="DemoCompletedScreen" component={DemoCompletedScreen} />
      ...
      <Stack.Screen name="OpenStock" component={OpenStockScreen} />
      <Stack.Screen name="ActionScreen" component={ActionScreen} />
      <Stack.Screen name="MapScreen" component={MapViewScreen} />
      <Stack.Screen name="DemoHistory" component={DemoHistoryScreen} />
      <Stack.Screen name="PDFViewer" component={PDFViewer} />
      <Stack.Screen name="TrainerSettingScreen" component={TrainerSettingScreen} />
      <Stack.Screen name="SalesManSettingScreen" component={SalesManSettingScreen} />
      <Stack.Screen name="ScheduleDemo" component={ScheduleDemoScreen} />
      <Stack.Screen name="TrainerList" component={TrainerListScreen} />
      <Stack.Screen name="SetCalendar" component={SetCalendarScreen} />
      <Stack.Screen name="ClientDemoHistory" component={ClientDemoHistoryScreen} />
      <Stack.Screen name="SalesHistory" component={SalesHistory} />
      <Stack.Screen name="TargetProduct" component={TargetProductScreen} />
      <Stack.Screen name="EditClient" component={EditClientDetails} />
      <Stack.Screen name="SplashScreen" component={SplashScreen} />
      <Stack.Screen name="NotesScreen" component={NotesScreen} />
      <Stack.Screen name="EditPreviewScreen" component={EditPreviewScreen} />
      <Stack.Screen name="EditBasicDetails" component={EditBasicDetails} initialParams={{ isFirstLogin: false }} />
      <Stack.Screen name="DemoMapViewScreen" component={DemoMapViewScreen} />
      <Stack.Screen name="NotificationScreen" component={NotificationScreen} />
      <Stack.Screen name="InviteHistoryScreen" component={InviteHistoryScreen} />
      <Stack.Screen name="ClientDetailScreen" component={ClientDetailScreen} />
      <Stack.Screen name="ProfileSalesHistory" component={ProfileSalesHistory} />
      <Stack.Screen name="FeedbackDetailScreen" component={FeedbackDetailScreen} />
      <Stack.Screen name="TeamsScreen" component={TeamsScreen} />
      <Stack.Screen name="ReportMainScreen" component={ReportMainScreen} />
    </Stack.Navigator>
  );
};
