...
const MultiSelectComponent: <T>(props: MultiSelectProps<T>) => ReactElement<any, string | JSXElementConstructor<any>> | null =
      ...
      (data: any[]) => {
        if (excludeItems.length > 0) {
          const getData = _differenceWith(
            data,
            excludeItems,
            (obj1: any, obj2: any) => _get(obj1, valueField) === _get(obj2, valueField)
          );
          return getData || [];
        } else {
          return data || [];
