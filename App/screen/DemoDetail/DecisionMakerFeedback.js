...
const DecisionMakerFeedback = props => {
  const decisionMakerDetail=props.decisionMaker;
    ...
    <ScrollView style={{width: '100%', height: '90%'}}>
     ...
     decisionMakerDetail?
      ...
      <TwoRadioButton
        ...
        selectedValue={decisionMakerDetail.question1}
        comments={decisionMakerDetail.question1Comment}
      />
      <TwoRadioButton
        questionNumber={'2'}
        title={Languages.Question2}
        selectedValue={decisionMakerDetail.question2}
        comments={decisionMakerDetail.question2Comment}
      />
      <TwoRadioButton
        questionNumber={'3'}
        title={Languages.Question3}
        selectedValue={decisionMakerDetail.question3}
        comments={decisionMakerDetail.question3Comment}
      />
      <TwoRadioButton
        questionNumber={'4'}
        title={Languages.Question4}
        selectedValue={decisionMakerDetail.question4}
        comments={decisionMakerDetail.question4Comment}
      />
      <MultipleRadioButton
       questionNumber={'5'}
       title={Languages.Question5}
       selectedValue={decisionMakerDetail.question5}
       options={["Very Well","Well","Neutral","Poorly","Very Poorly"]}
      />
       <MultipleRadioButton
       questionNumber={'6'}
       title={Languages.Question6}
       selectedValue={decisionMakerDetail.question6}
       options={["Excellent","Very Good","Good","Fair","Poor"]}
      />
       <MultipleRadioButton
       questionNumber={'7'}
       title={Languages.Question7}
       selectedValue={decisionMakerDetail.question7}
       options={["Very Likely","Likely","Neutral","Unlikely","Very Unlikely"]}
      />
        <MultipleRadioButton
       questionNumber={'8'}
       title={Languages.Question8}
       selectedValue={decisionMakerDetail.question8}
       options={["Excellent","Very Good","Good","Fair","Poor"]}
      />
        ...
        <View style={{flexDirection:'row'}}>
          ...
          <StarRating rating={decisionMakerDetail.ratings} />
        </View>
        </View>
        :
       ...
       Looks like Decision Maker doesn’t submitted his {'\n'}feedback yet
       </Text>
        </View>
     }
    </ScrollView>
...
export default DecisionMakerFeedback;
